...
const TermsOfService = () => {
  ...
  const keyTerms = [
    {
      ...
      description:
        "Must be 18+ years old with valid government ID and phone number",
    },
    {
      icon: Car,
      title: "Driver Requirements",
      description:
        "Valid driving license, vehicle registration, and insurance coverage",
    },
    {
      icon: CreditCard,
      title: "Payment Terms",
  ...
  const liabilityLimitations = [
    ...
    },
    {
      ...
      description:
        "We're not liable for actions of drivers, riders, or third parties",
    },
    {
        ...
        <div className="container-width">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              These terms govern your use of RideShare Pro services. Please read
            ...
            <Card className="mb-8">
              ...
              <CardContent className="prose max-w-none">
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  agreement between you and RideShare Pro ("Company," "we,"
                  "our," or "us") regarding your use of our ride-sharing
                  platform and services. By accessing or using our services, you
            ...
            <Card className="mb-8">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    RideShare Pro provides a technology platform that connects
                    riders with independent drivers for transportation services.
                    We do not provide transportation services directly but
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Users can register as riders (requesting transportation) or
                    drivers (providing transportation). Some users may have both
                    roles with separate registrations.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Service Areas</h3>
                  <p className="text-sm text-muted-foreground">
                    Our services are currently available in major cities across
                    Bangladesh. Service availability may vary by location and
                    time.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    these Terms when using our services.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Respectful Behavior</h3>
                  <p className="text-sm text-muted-foreground">
                    You must treat other users, customer support, and company
                    representatives with respect and courtesy.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    RideShare Pro. You have the freedom to choose when, where,
                    and how often to provide services.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Vehicle Requirements</h3>
                  <p className="text-sm text-muted-foreground">
                    Drivers must maintain vehicles that meet our safety and
                    quality standards, including valid registration, insurance,
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Drivers must pass background checks and maintain a clean
                    driving record. We reserve the right to conduct periodic
                    re-checks.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    punctuality, professionalism, and vehicle cleanliness.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Fares are calculated based on time, distance, demand, and
                    other factors. Dynamic pricing may apply during peak hours
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    We facilitate payment processing between riders and drivers.
                    Riders authorize us to charge their selected payment method
                    for rides and applicable fees.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Service Fees</h3>
                  <p className="text-sm text-muted-foreground">
                    We charge service fees to drivers for use of the platform.
                    Fee structures are communicated separately and may change
                    with notice.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Refund requests are handled on a case-by-case basis. We
                    provide a dispute resolution process for payment-related
                    issues.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent>
                ...
                <div className="mt-4 p-4 bg-red-50 rounded-lg">
                  <p className="text-sm text-red-800">
                    <strong>Violation Consequences:</strong> Violations may
                    result in account suspension, termination, or legal action.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Important:</strong> RideShare Pro is a technology
                    platform connecting users. We are not responsible for the
                    actions, behavior, or services provided by drivers or
                    riders.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    owned by RideShare Pro and protected by copyright,
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    license to use our services for personal, non-commercial
                    purposes.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    You retain ownership of content you provide but grant us a
                    license to use it for service provision and improvement.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    these Terms, illegal activities, or other reasons at our
                    discretion.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    immediately. Some provisions of these Terms survive
                    termination.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    first to resolve any disputes informally.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    disputes will be resolved in the courts of Bangladesh.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Arbitration</h3>
                  <p className="text-sm text-muted-foreground">
                    For certain disputes, we may require binding arbitration as
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  ...
                  users of material changes through the app, email, or by
